...
const Dashboard = ({ weeklyVolume }: Props) => {
    ...
    return (
        <div className="h-full  text-white relative overflow-hidden flex flex-col justify-center ">
            ...
            {/* 1. Removemos o max-w-md daqui, porque o MainLayout já controla a largura máxima */}
            {/* 2. Removemos paddings extra, usamos apenas w-full para preencher o que o pai deu */}
            ...
            ${
                ...
                <GlassBtn
                    ...
                    className="w-full py-5 rounded-2xl bg-white/5 border border-white/10 text-zinc-400 font-bold uppercase text-[10px] tracking-widest transition-all duration-200 hover:bg-white/10 hover:text-white active:bg-white/15 active:scale-[0.98]"
                >
                    Past Workouts
                </GlassBtn>
                ...
                <GlassBtn
                    ...
                    className="w-full py-4 rounded-xl border border-dashed border-system/30 bg-system/5 text-system-light/70 active:bg-system/10 active:border-system/50 transition-all"
                >

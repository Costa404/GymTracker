...
const GlassBtn = ({
    ...
    const variants = {
        ...
        performance:
            "bg-transparent text-performance-light border-performance/40 active:border-performance/60 active:text-performance shadow-[0_0_20px_var(--color-performance-light)/10]",
        system: "bg-transparent text-system-light border-system/40 active:border-system/60 active:text-system",

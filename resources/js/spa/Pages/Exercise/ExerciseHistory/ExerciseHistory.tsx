...
import { formatDate, useExerciseHistory } from "./useExerciseHistory";
import { EmptyExerciseHistory, Stat } from "./ExerciseHistoryUI";
import ExerciseProgressGraph from "./ExerciseProgressGraph";
import ExerciseLogHeader from "../ExerciseLog/ExerciseLogHeader";
...
const ExerciseHistory = () => {
    ...
    const sortedGroups = useExerciseHistory(history);

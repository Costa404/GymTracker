import { ExerciseLogInputGroupProps } from "@/types";

const ExerciseLogInputGroup = ({
    label,
    value,
    onChange,
    suffix,
    placeholder = "0",
    lastSets = [],
}: ExerciseLogInputGroupProps & { lastSets?: (string | number)[] }) => (
...
export default ExerciseLogInputGroup;

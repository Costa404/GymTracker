...
const WorkoutTemplates = () => {
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            await fetch(`/api/workout-config/templates/${id}`, {
                method: "DELETE",
            });
    ...
    return (
        <div className="w-full font-sans">
            ...
            {/* Listagem apenas para visualização e eliminação */}
            <div
                ...
                {templates.map((template) => (
                    ...
                    >
                        <div className="flex-1 min-w-0 pr-4">
                            {/* Retiradas as animações de active: do texto */}
                        ...
                        {/* Botão de Delete (Agora a usar a tua variante red para assumir o destaque) */}
                        <GlassBtn
